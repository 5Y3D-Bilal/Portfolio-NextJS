...
const AnimatedNumbers = ({ value }) => {
  ...
  useEffect(() => {
    springValue.on('change', (latest) => {
      console.log(Math.floor(latest + 1))
        ...
        <Layout className='pt-16' >
          ...
          <div className='grid w-full grid-cols-8 gap-16 '>
            <div className='col-span-3 flex flex-col items-start justify-start'>
              ...
              <p className='font-medium dark:text-light'>   Whether I'm working on a website, mobile app, or
            ...
            <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8'>
              ...
              <Image src={profilePIC} alt='a' className='w-full h-auto rounded-2xl ' />
            </div>
            ...
            <div className='col-span-2 flex flex-col items-end justify-between'>
              ...
              <div className='flex flex-col items-end justify-center'>
                <span className='inline-block text-7xl font-bold dark:text-light'><AnimatedNumbers value={100} /></span>
                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light'>projects completed</h2>
              </div>

              <div className='flex flex-col items-end justify-center'>
                <span className='inline-block text-7xl font-bold dark:text-light'><AnimatedNumbers value={5} /></span>
